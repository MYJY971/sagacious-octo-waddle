...
Sphere::Sphere(const PointCloud * const pc, float radius, int nU, int nV) :
    mRadius(radius)
{
...
void Sphere::setTransformationMatrix(const Eigen::Matrix4f& transfo, Face* face)
{
...
void Sphere::giveVertices(Face* face, Vector3f pos1, Vector3f pos2, Vector3f pos3)
{
/* Vector3f v1(0.5,0,0);
 Vector3f v2(-0.5,0,0);
 Vector3f v3(0,0.5,0);
